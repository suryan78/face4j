...
public class AsyncFaceClient implements Serializable
{
	...
	public void addTag (final String url, final float x, final float y, final int width, final int height, final String uid, final String label, final String taggerId)
	{
		new Thread() 
		{
			public void run() 
	...
	public void getTags (final String pids, final String urls, final String uids, final String order, final String filter, final boolean together, final int limit)
	{
		new Thread() 
		{
			public void run() 
			{
				try 
				{
					List<Photo> photos = faceClient.getTags(pids, urls, uids, order, filter, together, limit);
	...
	public void getTags (final String urls, final String uids, final String order, final String filter, final boolean together, final int limit)
	{
		new Thread() 
		{
			public void run() 
			{
				try 
				{
					List<Photo> photos = faceClient.getTags(urls, uids, order, filter, together, limit);
	...
	public void namespaces () throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
	...
	public void recognize (final String urls, final String uids) throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
	...
	public void removeTags (final String tids) throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
	...
	public void saveTags (final String tids, final String uid, final String label) throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
	...
	public void status (final String uids) throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
	...
	public void train (final String uid) throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
	...
	public void users (final String namespaces) throws FaceClientException, FaceServerException
	{
		new Thread() 
		{
			public void run() 
